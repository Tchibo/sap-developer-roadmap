A business object event is a creation or change to a business object within SAP. This trigger causes a notification event, which contains the data about the change and the business object.
