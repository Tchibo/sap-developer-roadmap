...
In order to reduce manual effort in the future and to standardise and partially automate deployment processes, we want to use a (semi-)automatic pipeline with SAP Cloud ALM, SAP Continuous Integration and Delivery and SAP Cloud Transport Management.
